    ...
    <div className="flex flex-col gap-7">
      <div>
       ...
       <div className="flex flex-col gap-12 md:flex-row  flex-grow"> 
        <ListWork title={"Full stack online fashion store"} tech={"using nextjs + pocketbase"} url={"https://github.com/ayoubbijarche/fashion-store-sample"} img={"https://nextui.org/images/hero-card-complete.jpeg"}/>
